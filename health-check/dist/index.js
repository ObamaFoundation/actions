...
/* harmony import */ var _assertions__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(604);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // JSON Assertions
            const assertions = (0,_assertions__WEBPACK_IMPORTED_MODULE_1__/* .parse */ .Q)(ARGS.json_assertions);
            if (assertions.length > 0) {
                const json = yield response.json();
                assertions.forEach((assertion) => {
                    const { left, op, right } = assertion;
                    results.push((0,_assertions__WEBPACK_IMPORTED_MODULE_1__/* .assert */ .h)({ left: json[left], op, right }));
                });
            }
            if (results.some((r) => r.result == "fail")) {
                _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(`Action failed health check`);
            }
        }
        catch (error) {
